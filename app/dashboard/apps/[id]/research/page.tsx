...
export default async function AppResearchPage({
  ...
  const [
    ...
    supabaseAdmin
      .from("apps")
      .select(
        "id, name, source_url, dna, agent_credits_used_this_week, agent_credits_reset_at, agent_action_cooldowns, first_research_completed, first_research_completed_at, preferred_research_day, preferred_research_hour"
      )
      .eq("id", id)
